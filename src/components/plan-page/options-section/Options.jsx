    ...
    <>
      <section class="options-section">
        <div class="option-container">
          ...
          <img src={arrowIcon} alt="Arrow icon" class="arrow" data-arrow />
          <div class="options-container">
            ...
            <div class="option-box" data-option>
              <h2 class="option-title" data-option-title>
                Filter
              </h2>
            ...
            <div class="option-box" data-option data-option-last>
              <h2 class="option-title" data-option-title data-option-title-last>
                Espresso
              </h2>
              <p
                class="option-description"
      ...
      <div class="create-plan-order-container">
        <button class="create-plan-order" data-plan>
          create my plan
        </button>
      </div>
    </>
